...
Use uppercase controlled sensitive_data_type names such as EMAIL_ADDRESS,
PHONE_NUMBER, DATE_OF_BIRTH, IN_PAN, IN_AADHAAR, CREDIT_CARD_NUMBER,
MEDICAL_RECORD_NUMBER, MEMBER_IDENTIFIER, CLAIM_IDENTIFIER, PROVIDER_IDENTIFIER,
DIAGNOSIS_CODE, PROCEDURE_CODE, SERVICE_DATE, FINANCIAL_AMOUNT,
SOCIAL_SECURITY_NUMBER, FIRST_NAME, LAST_NAME, and NONE.
Do not invent new sensitive_data_type names.
